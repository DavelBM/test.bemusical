                    ...
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="header" bgcolor="#c7d8a7">
                                Here all the summary details for your upcoming gig
                            </td>
                        </tr>
                        <tr>
                            <td>
                                We are excited to inform that you will be in {{$c_name}}'s event, Here summary details (to see all data you can check in your dashboard):
                                <br>
                                <p>
                                ...
                                @if($type == 'cash')
                                    @php
                                        $total = $price-$amount;
                                    @endphp
                                    Cash: <strong>Client has to pay before event {{$total}}</strong><br>
                                @endif
