                ...
                <td>
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td>
                                <br>
                                <strong>{{$name}}</strong> already sent a request for availability to any soloist or ensenble. Here are all the data that you need to follow the request.
                                <br>
                                <p>
                                Name: <strong>{{$name}}</strong><br>
                                Email Client: <strong>{{$email}}</strong><br> 
                                ...
                                Soloist or Ensemble : <strong>{{$type}}</strong><br>
                                @if($comment != null)
                                    Comments:
