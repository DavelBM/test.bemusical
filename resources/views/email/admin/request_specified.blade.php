                    ...
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="header" bgcolor="#c7d8a7">
                                This email was sent it to {{$email}}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Hi Admin,
                                <br>
                                <strong>{{$name}}</strong> already sent a request for availability to {{$user_name}}. Here are all the data that you need to follow the request.
                                <br>
                                <p>
