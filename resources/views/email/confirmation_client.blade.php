                    ...
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="header" bgcolor="#c7d8a7">
                                Here all the details for your upcoming gig
                                @if($flag == 0)
                                <strong>You can check all the information in your dashboard</strong>
                        ...
                        <tr>
                            <td>
                                We are excited to inform your payment was approved {{$c_name}}, and {{$u_name}} will be in your event. Here summary details:
                                <br>
                                <p>
                                ...
                                @if($type == 'cash')
                                    @php
                                        $total = $price-$amount;
                                    @endphp
                                    Cash: <strong>You have to pay before the event {{$total}}</strong><br>
                                @elseif($type == 'stripe')
                                    Payment: <strong>Credit/Debit card</strong><br>
                                @elseif($type == 'transfer')
                                    Payment: <strong>Bank Transfer</strong><br>
                                @endif
                                On: <strong>{{$day}}</strong>
                                </p>
                            </td>
                        </tr>
                        <tr>
