                    ...
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="header" bgcolor="#c7d8a7">
                                {{$name}}, you have an invitation to be part of an ensemble
                            </td>
                        </tr>
                        <tr>
                            <td>
                            	Do you want to be part of "{{$ensemble_name}}"? 
								<a class="btn btn-primary" type="button" href="{{ URL::to('/ensemble/invitation/'.$token) }}">OK</a> <br> or follow this link <br>
								{{ URL::to('/ensemble/invitation/'.$token) }}
                            </td>
                        </tr>
                        <tr>
