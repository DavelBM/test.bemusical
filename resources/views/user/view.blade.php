...
@section('script')
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        //        key : 'AIzaSyAiSpxjqWzkCFUzn6l1H-Lh-6mNA8OnKzI',
        //
        //    },
        //    function(data) {
        ...
        //    }
        //);
        $.getJSON('https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=place_id:EjdBdiBHdWFkYWx1cGUgMzQyLCBDaGFwYWxpdGEsIEd1YWRhbGFqYXJhLCBKYWwuLCBNw6l4aWNv&destinations=New+York+City,NY&key=AIzaSyAiSpxjqWzkCFUzn6l1H-Lh-6mNA8OnKzI', function(data){
            console.log(data);
        })
      });
    }
