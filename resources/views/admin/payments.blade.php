                ...
                <div class="panel-body">
                    ...
                    @foreach($payments as $request)
                        @php
                            ...
                            $charge = $stripe->charges()->find($request->payment['_id_charge']);
                            try {
                                $bank_name = $charge['source']['brand'];
                            } catch (\Exception $e) {
                                $bank_name = $charge['source']['bank_name'];
                            }
                        ...
                        <div id="details{{$request->id}}">
                            ...
                            <p>Type: <strong>{{$message_payment}}</strong> - {{$bank_name}}</p>
                        </div>
                    @endforeach
                    @endif
                </div>
